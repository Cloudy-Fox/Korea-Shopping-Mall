package com.koreamall.contoller.customer_service;
...
public class CustomerServiceController {
    ...
    /***
     ...
     @return true: 게시물이 이미 조회된 적이 있음 false:게시물이 조회된 적이 없음
     ***/
    private boolean is_entered(
        ...
        // 쿠키가 존재한다면 기존 쿠키에 값을 받아옴
            ...
            if(!value.contains(String.valueOf(postNo))){
                ...
                oneOnOneCookie.setMaxAge(60); // 최대 1분
